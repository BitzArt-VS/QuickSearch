...
When making any API changes, make sure to output the whole proposed API design on every iteration, and clearly highlight the changes you made using the format provided in `.agents/format/api-design.md`.
...
- Would an uninitiated user not be able to understand it if they this response in isolation without any additional context?
