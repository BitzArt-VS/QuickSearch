...
public class GuiDropdown<T> : GuiInputBase
{
    ...
    public override GuiSize Measure(double availableWidth, double availableHeight)
    {
        ...
        // LayoutParameters.Height (set in the constructor).
        return new GuiSize(120, LayoutParameters.Height ?? 30);
    }
    ...
    protected override void BuildRenderTree(IGuiRenderTreeBuilder builder)
    {
        ...
        double headerHeight = LayoutParameters.Height ?? 30;
    ...
    private void BuildPopupOverlay(IGuiRenderTreeBuilder builder)
    {
        ...
        builder.AddContainer<GuiDropdownPopup>(0,
            ...
            .Configure(p =>
            {
                ...
                p.Scroll = overflow ? GuiScroll.Vertical : GuiScroll.None;
                p.Scrollbar = overflow ? GuiScroll.Vertical : GuiScroll.None;
            });
    }
